...
const VideoButton = ({ id, timelinelist, setTimelinelist, }) => {
    ...
    return (
        <div onClick={() => handleAddtoTimeline()} className="btn h-25 p-8 flex flex-col lg:w-62.5 gap-5 text-center bg-[#f8fafc] rounded-2xl border border-solid border-[#fff] shadow">
